# Opening the "firststep.txt" file and creating a new lesson plan
with open("firststep.txt", "r") as file:
    content = file.read()
...
# Saving the lesson plan as a Markdown file
with open("secondstep.md", "w") as file:
    file.write(lesson_plan)

print("Lesson plan has been saved to secondstep.md")